...
#define xocean_atomic_cas_explicit(/* ptr */ ptr , /* ptr */ expected , \
                          /* ptr */ desired , /* flag */ success_order , \
                          /* flag */ failure_order)  \
        xocean_atomic_cas_strong(ptr , expected , desired , success_order , \
                                 failure_order)

#define xocean_atomic_load_implicit(ptr)  \
        __atomic_load(ptr , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_store_implicit(ptr , val)  \
        __atomic_store(ptr , val , XOCEAN_ATOMIC_SEQ_CST)

#define xocean_atomic_add_fetch_implicit(ptr , val)  \
        __atomic_fetch_add(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_sub_fetch_implicit(ptr , val)  \
        __atomic_fetch_sub(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_and_fetch_implicit(ptr , val)  \
        __atomic_fetch_and(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_or_fetch_implicit(ptr , val)   \
        __atomic_fetch_or(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_xor_fetch_implicit(ptr , val)  \
        __atomic_fetch_xor(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_nand_fetch_implicit(ptr , val)  \
        __atomic_fetch_nand(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_max_fetch_implicit(ptr , val)  \
        __atomic_fetch_max(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_min_fetch_implicit(ptr , val)  \
        __atomic_fetch_min(ptr , val , XOCEAN_ATOMIC_SEQ_CST)

#define xocean_atomic_fetch_add_implicit(ptr , val)  \
        __atomic_fetch_add(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_fetch_sub_implicit(ptr , val)  \
        __atomic_fetch_sub(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_fetch_and_implicit(ptr , val)  \
        __atomic_fetch_and(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_fetch_or_implicit(ptr , val)   \
        __atomic_fetch_or(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_fetch_xor_implicit(ptr , val)  \
        __atomic_fetch_xor(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_fetch_nand_implicit(ptr , val)  \
        __atomic_fetch_nand(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_fetch_max_implicit(ptr , val)  \
        __atomic_fetch_max(ptr , val , XOCEAN_ATOMIC_SEQ_CST)
#define xocean_atomic_fetch_min_implicit(ptr , val)  \
        __atomic_fetch_min(ptr , val , XOCEAN_ATOMIC_SEQ_CST)

#define xocean_atomic_exchange_implicit(ptr , val)  \
        __atomic_exchange(ptr , val , XOCEAN_ATOMIC_SEQ_CST)

#define xocean_atomic_cas_weak_implicit(/* ptr */ ptr , /* ptr */ expected , \
                          /* ptr */ desired)  \
        xocean_atomic_cas_weak_explicit(ptr , expected , desired , \
                                        XOCEAN_ATOMIC_SEQ_CST , \
                                        XOCEAN_ATOMIC_SEQ_CST)

#define xocean_atomic_cas_strong_implicit(/* ptr */ ptr , /* ptr */ expected , \
                              /* ptr */ desired)  \
        xocean_atomic_cas_strong_explicit(ptr , expected , desired , \
                                          XOCEAN_ATOMIC_SEQ_CST , \
                                          XOCEAN_ATOMIC_SEQ_CST)

#define xocean_atomic_cas_implicit(/* ptr */ ptr , /* ptr */ expected , \
                                     /* ptr */ desired)  \
        xocean_atomic_cas_strong(ptr , expected , desired , \
                                 XOCEAN_ATOMIC_SEQ_CST , XOCEAN_ATOMIC_SEQ_CST)
