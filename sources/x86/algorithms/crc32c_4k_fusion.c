...
__xoc_crc32c_4k_fusion(
    ...
    xoc_uint32_t acc_b = 0;
    xoc_uint32_t acc_c = 0;
    ...
    xoc_byte_t * end = buf + 4096 - 64;
    do 
    {
        acc_a = _mm_crc32_u64(acc_a , *(xoc_uint64_t *)buf);
        __m128i x5 = _mm_clmulepi64_si128(x1 , k1k2 , 0x00);
        acc_b = _mm_crc32_u64(acc_b , *(xoc_uint64_t *)(buf + 728));
        x1 = _mm_clmulepi64_si128(x1 , k1k2 , 0x11);
        acc_c = _mm_crc32_u64(acc_c , *(xoc_uint64_t *)(buf + 728*2));
        __m128i x6 = _mm_clmulepi64_si128(x2 , k1k2 , 0x00);
        acc_a = _mm_crc32_u64(acc_a , *(xoc_uint64_t *)(buf + 8));
        x2 = _mm_clmulepi64_si128(x2 , k1k2 , 0x11);
        acc_b = _mm_crc32_u64(acc_b , *(xoc_uint64_t *)(buf + 728 + 8));
        __m128i x7 = _mm_clmulepi64_si128(x3 , k1k2 , 0x00);
        acc_c = _mm_crc32_u64(acc_c , *(xoc_uint64_t *)(buf + 728*2 + 8));
        x3 = _mm_clmulepi64_si128(x3, k1k2 , 0x11);
        acc_a = _mm_crc32_u64(acc_a , *(xoc_uint64_t *)(buf + 16));
        __m128i x8 = _mm_clmulepi64_si128(x4 , k1k2 , 0x00);
        acc_b = _mm_crc32_u64(acc_b , *(xoc_uint64_t *)(buf + 728 + 16));
        x4 = _mm_clmulepi64_si128(x4, k1k2, 0x11);
        acc_c = _mm_crc32_u64(acc_c , *(xoc_uint64_t *)(buf + 728*2 + 16));
    ...
    acc_c = _mm_crc32_u64(acc_c , *(xoc_uint64_t *)(buf + 728*2 + 16));
    x1 = _mm_xor_si128(x1, x5);
    acc_a = _mm_crc32_u64(acc_a , *(xoc_uint64_t *)(buf + 24));
    // k5 == magic(2*128+32-1)
    // k6 == magic(2*128-32-1)
    ...
    acc_b = _mm_crc32_u64(acc_b , *(xoc_uint64_t *)(buf + 728 + 24));
    ...
    x1 = _mm_xor_si128(x1 , x5);
    xoc_uint64_t abc = _mm_cvtsi128_si64(
        _mm_xor_si128(_mm_xor_si128(vec_c , vec_a) , vec_b)
    );
    // Apply missing <<32 and fold down to 32-bits.
    xoc_uint32_t crc = _mm_crc32_u64(0 , _mm_extract_epi64(x1 , 0));
